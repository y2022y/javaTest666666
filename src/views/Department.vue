...
<!--      <el-input style="width: 200px" placeholder="请输入" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>-->
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="departmentDesc" label="部门描述"></el-table-column>
      <el-table-column prop="departmentEmployee" label="部门员工">
        <template slot-scope="scope">
          <el-button type="success" @click="getDepartmentEmployee(scope.row.flag)">查看详情</el-button>
        </template>
      </el-table-column>
      <el-table-column prop="flag" label="部门标识"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="40%" :close-on-click-modal="false">
      <el-form label-width="120px" size="small" style="width: 80%; margin: 0 auto">
        ...
        <el-form-item label="部门描述">
          <el-input v-model="form.departmentDesc" autocomplete="off"></el-input>
        </el-form-item>
    ...
    <el-dialog title="部门人员名单" :visible.sync="dialogDepartment" width="40%" :close-on-click-modal="false" >
      <el-table
          :data="employees"
          style="width: 100%">
        <el-table-column
...
export default {
  ...
  methods: {
    ...
    getDepartmentEmployee(flag){
      this.dialogDepartment = true;
      // console.log(flag)
      this.request.get("/user/findByFlag",{
        params:{
          flag:flag
        }
      }).then(res => {
