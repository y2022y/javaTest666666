<template>
  <div class="wrapper">
    ...
    <div style="margin: 150px auto; background-color: saddlebrown; width: 350px; height: 340px; padding: 20px; border-radius: 10px">
...
<style>
  .wrapper {
    height: 100vh;
    background-image: url("https://images.pexels.com/photos/3153207/pexels-photo-3153207.jpeg?auto=compress&cs=tinysrgb&w=1200");
