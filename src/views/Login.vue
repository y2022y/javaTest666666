<template>
  <div class="wrapper">
    <div style="height: 60px; line-height: 60px; font-size: 20px; padding-left: 50px; color: saddlebrown;
      background-color: rgba(0,0,0,0.2)">企业员工信息管理系统</div>
    <div style="margin: 150px auto; background-color: saddlebrown; width: 350px; height: 300px; padding: 20px; border-radius: 10px">
...
.wrapper {
  height: 100vh;
  background-image: url("https://images.pexels.com/photos/7070/space-desk-workspace-coworking.jpg?auto=compress&cs=tinysrgb&w=1200");
