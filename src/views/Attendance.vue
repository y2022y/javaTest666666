<template>
  <div>
    <div style="margin: 10px 0">
      <el-input style="width: 200px" placeholder="请输入员工名称" suffix-icon="el-icon-search" v-model="name"></el-input>
...
<!--      <el-input style="width: 200px" placeholder="请输入" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>-->
    ...
    <div style="margin: 10px 0">
      ...
      <el-upload action="http://localhost:9090/attendance/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="hoursWorked" label="工时"></el-table-column>
      <el-table-column prop="late" label="是否迟到"></el-table-column>
      <el-table-column prop="earlyLate" label="是否早退"></el-table-column>
<!--      <el-table-column prop="leaveType" label="请假类型"></el-table-column>-->
      <el-table-column prop="overtime" label="加班情况"></el-table-column>
      <el-table-column prop="absentType" label="判断是否缺勤"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="40%" :close-on-click-modal="false">
      <el-form label-width="120px" size="small" style="width: 80%; margin: 0 auto">
        ...
        <el-form-item label="是否迟到">
          <el-select clearable v-model="form.late" placeholder="是否迟到" style="width: 100%">
            <el-option v-for="item in judgment" :key="item.name" :label="item.name" :value="item.flag"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="是否早退">
          <el-select clearable v-model="form.earlyLate" placeholder="是否早退" style="width: 100%">
            <el-option v-for="item in judgment" :key="item.name" :label="item.name" :value="item.flag"></el-option>
          </el-select>
        </el-form-item>
...
<!--        </el-form-item>-->
        <el-form-item label="是否加班">
          <el-select clearable v-model="form.overtime" placeholder="是否加班" style="width: 100%">
            <el-option v-for="item in judgment" :key="item.name" :label="item.name" :value="item.flag"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="是否缺勤">
          <el-select clearable v-model="form.absentType" placeholder="是否缺勤" style="width: 100%">
            <el-option v-for="item in judgment" :key="item.name" :label="item.name" :value="item.flag"></el-option>
          </el-select>
        </el-form-item>
