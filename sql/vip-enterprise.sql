/*
 ...
 Source Schema         : vip-enterprise

 Target Server Type    : MySQL
 Target Server Version : 50724
 File Encoding         : 65001

 Date: 30/10/2023 11:25:40
*/
...
CREATE TABLE `attendance`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '出勤记录的编号',
  `employee_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '员工姓名',
  `start_time` datetime NULL DEFAULT NULL COMMENT '上班时间',
  `end_time` datetime NULL DEFAULT NULL COMMENT '下班时间',
  `hours_worked` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '工时',
  `late` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '判断是否迟到',
  `early_late` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '判断是否早退',
  `leave_type` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '请假类型',
  `overtime` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '加班情况',
  `absent_type` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '判断是否缺勤',
  `remarks` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '备注',
  `recorder` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '记录者',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1409286146 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of attendance
-- ----------------------------
INSERT INTO `attendance` VALUES (1115684866, '王五', '2023-08-02 09:00:00', '2023-08-02 15:00:00', '360分钟', '是', '是', NULL, '否', '否', 'test', '王天一');
INSERT INTO `attendance` VALUES (1409286145, '张三', '2023-08-02 08:00:00', '2023-08-02 18:00:00', '600分钟', '否', '否', NULL, '是', '否', '张三工作认真上进', '王天一');
...
CREATE TABLE `department`  (
  ...
  `department_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '部门名称',
  `department_desc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '部门描述',
  `department_employee` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '部门员工',
...
-- ----------------------------
INSERT INTO `department` VALUES (1, '行政部', '管理行政的部门', '', '2023-07-13 22:15:16', 'ADMINISTRATIVE');
INSERT INTO `department` VALUES (2, '研发部', '研发软件的部门', '', '2023-07-13 22:15:49', 'RESEARCH');
INSERT INTO `department` VALUES (3, '后勤部', '管理后勤的部门', '', '2023-07-14 23:12:17', 'LOGISTICS');
INSERT INTO `department` VALUES (4, '销售部门', '负责产品销售、市场营销、客户关系管理等', NULL, '2023-07-15 15:04:38', 'SALES');
...
CREATE TABLE `leaves`  (
  ...
  `type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '请假类型',
  `start_time` datetime NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` datetime NULL DEFAULT NULL COMMENT '结束时间',
  `days` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '请假天数',
  `auditor` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '请假审核人',
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '请假状态',
  `reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '请假原因',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of leaves
-- ----------------------------
INSERT INTO `leaves` VALUES (10, '王五', '事假', '2023-08-02 22:24:38', '2023-08-05 00:00:00', '3天', '王天一', '已经同意请假申请', '家中有急事希望能够审批通过');
...
-- Records of sys_file
-- ----------------------------
INSERT INTO `sys_file` VALUES (1, '1.jpeg', 'jpeg', 121, 'http://localhost:9090/file/e0adc63be5c34a4eb950c00f67ff8920.jpeg', '0ee3c55f87d0f2be7db2cb59e4e66928', 0, 1);
INSERT INTO `sys_file` VALUES (2, 'IMG_20230726_235214.jpg', 'jpg', 351, 'http://localhost:9090/file/e547fb7cb5b1480c9ef64a82a06ed47a.jpg', 'd26962a94f3ad6d7d447289896be46b8', 0, 1);
...
INSERT INTO `sys_menu` VALUES (12, '员工管理', '/employee', 'el-icon-user', NULL, NULL, 'User', 106);
INSERT INTO `sys_menu` VALUES (13, '部门管理', '/department', 'el-icon-more', NULL, NULL, 'Department', 105);
INSERT INTO `sys_menu` VALUES (15, '请假申请', '/leaveApplication', 'el-icon-s-cooperation', NULL, NULL, 'LeaveApplication', 104);
INSERT INTO `sys_menu` VALUES (16, '请假管理', '/leaves', 'el-icon-menu', NULL, NULL, 'Leaves', 102);
INSERT INTO `sys_menu` VALUES (17, '考勤管理', '/attendance', 'el-icon-s-flag', NULL, NULL, 'Attendance', 103);
INSERT INTO `sys_menu` VALUES (18, '工资查询', '/salary', 'el-icon-document-copy', NULL, NULL, 'Salary', 101);
INSERT INTO `sys_menu` VALUES (19, '数据展示', '/echarts', 'el-icon-notebook-2', NULL, NULL, 'Echarts', 1);
...
INSERT INTO `sys_role` VALUES (2, '普通员工', '普通员工', 'ROLE_USER');
...
CREATE TABLE `sys_user`  (
  ...
  `occupation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '员工职业',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', 'admin', '王天一', 'admin@qq.com', '13988997788', '北京', '2022-01-22 00:00:00', 'http://localhost:9090/file/e0adc63be5c34a4eb950c00f67ff8920.jpeg', 'ROLE_ADMIN', 3000.00, NULL, '后端开发工程师', 'ADMINISTRATIVE');
INSERT INTO `sys_user` VALUES (2, 'zhang', '123', '张三', 'zhang@qq.com', '13677889900', '南京', '2022-02-26 22:10:14', NULL, 'ROLE_USER', 4000.00, NULL, '后端开发工程师', 'SALES');
INSERT INTO `sys_user` VALUES (3, 'wang', '123', '王五', 'wang@qq.com', '13877668855', '上海', '2022-02-26 22:10:18', 'http://localhost:9090/file/e547fb7cb5b1480c9ef64a82a06ed47a.jpg', 'ROLE_USER', 5000.00, NULL, '后端开发工程师', 'ADMINISTRATIVE');
INSERT INTO `sys_user` VALUES (4, 'wangtianyi', '123', '王天一', '2217969395@qq.com', '15922309735', '西青区津静路22号天津农学院东校区', '2023-10-30 00:13:05', NULL, 'ROLE_USER', 12000.00, NULL, '前端开发工程师', 'RESEARCH');
INSERT INTO `sys_user` VALUES (5, 'sdasda', '123', '陈雪娇', '2217969395@qq.com', '15922309735', '西青区津静路22号天津农学院东校区', '2023-10-29 00:14:10', NULL, 'ROLE_USER', 5000.00, NULL, '保洁阿姨', 'LOGISTICS');
INSERT INTO `sys_user` VALUES (7, 'sa', '123', '张三封', '2217969395@qq.com', '15922309735', '西青区津静路22号天津农学院', '2023-10-31 00:15:07', NULL, 'ROLE_USER', 3000.00, NULL, '全栈开发工程师', 'RESEARCH');
INSERT INTO `sys_user` VALUES (8, 'sadsdasda', '123', '林知为', '2217969395@qq.com', '15922309735', '西青区津静路22号天津农学院东校区', '2023-10-15 00:15:25', NULL, 'ROLE_USER', 10000.00, NULL, '后端开发工程师', 'RESEARCH');
INSERT INTO `sys_user` VALUES (9, 'fdsjfkj', '123', '何浩然', '2217969395@qq.com', '15922309735', '西青区津静路22号天津农学院东校区', '2023-10-29 00:25:55', NULL, 'ROLE_USER', 1000.00, NULL, '全栈开发工程师', 'RESEARCH');
